...
# @LastEditors: Radon
# @LastEditTime: 2023-02-22 17:03:53
...
download() {
    ...
    rm -rf libxml2-7d02c729
    cp -r SRC libxml2-7d02c729
    cd libxml2-7d02c729
    git checkout 7d02c729
}
...
afl() {
    ...
    for ((i = 1; i <= $1; i++)); do
        ...
        gnome-terminal -t "secondary" -- bash -c "timeout 2h $AFL/afl-fuzz -S secondary -m none -i in -o out$i ./xmllint @@" &
        timeout 2h $AFL/afl-fuzz -M main -m none -i in -o out$i ./xmllint @@
    done
}
...
aflgo() {
    ...
    echo $'parser.c:11521\nparser.c:11525\nparser.c:11610\nparser.c:2143\nparser.c:6810\nparser.c:6815\nparser.c:7034\nparser.c:7044\nparser.c:8355\nparser.c:8371\nparser.c:8550\nparser.c:8616\nparser.c:9300\nparser.c:9482\nparser.c:9866\nparser.c:9926' >$TMP_DIR/BBtargets.txt
    ...
    for ((i = 1; i <= $1; i++)); do
        ...
        gnome-terminal -t "secondary" -- bash -c "timeout 2h $AFLGO/afl-fuzz -S secondary -z exp -c 45m -m none -i in -o out$i ./xmllint @@"
        timeout 2h $AFLGO/afl-fuzz -M main -z exp -c 45m -m none -i in -o out$i ./xmllint @@
    done
}
...
myfuzz() {
    ...
    for ((i = 1; i <= $1; i++)); do
        ...
        gnome-terminal -t "secondary" -- bash -c "timeout 2h $CIDFUZZ/afl-fuzz -S secondary -m none -i in -o out$i ./xmllint @@"
        timeout 2h $CIDFUZZ/afl-fuzz -M main -m none -i in -o out$i ./xmllint @@
    done
}
