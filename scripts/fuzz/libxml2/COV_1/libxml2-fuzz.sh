###
 ...
 # @LastEditors: Radon
 # @LastEditTime: 2022-07-10 18:50:45
...
afl() {
    ...
    for ((i = 1; i <= $1; i++)); do
        ...
        gnome-terminal -t "secondary" -- bash -c "$AFL/afl-fuzz -S secondary -m none -k 120 -i in -o out$i ./xmllint @@" &
        $AFL/afl-fuzz -M main -m none -k 120 -i in -o out$i ./xmllint @@
    done
}
...
aflgo() {
    ...
    for ((i = 1; i <= $1; i++)); do
        ...
        gnome-terminal -t "secondary" -- bash -c "$AFLGO/afl-fuzz -S secondary -z exp -c 45m -m none -k 120 -i in -o out$i ./xmllint @@"
        $AFLGO/afl-fuzz -M main -z exp -c 45m -m none -k 120 -i in -o out$i ./xmllint @@
    done
}
...
myfuzz() {
    ...
    for ((i = 1; i <= $1; i++)); do
        ...
        gnome-terminal -t "secondary" -- bash -c "$MYFUZZ/afl-fuzz -S secondary -m none -k 120 -i in -o out$i ./xmllint @@"
        $MYFUZZ/afl-fuzz -M main -m none  -k 120 -i in -o out$i ./xmllint @@
    done
}
