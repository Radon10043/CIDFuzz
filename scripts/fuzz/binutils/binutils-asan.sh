...
# @LastEditors: Radon
# @LastEditTime: 2023-01-27 15:40:11
...
# for f in `ls | grep id`; do echo -e "\n${f}" | cut -d ',' -f 1-3 >> 0.txt | cat $f | /home/radon/Documents/fuzzing/TEMP/binutils/ASAN/obj-asan/binutils/cxxfilt 2>&1 | grep '#[0-2] ' | tee -a 0.txt; done
